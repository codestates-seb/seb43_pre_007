...
//Todo ----- 인증오류,권한오류(현재빠져있음) 발생시 처리방법 설정부분 -----
    ...
    @Bean
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://stackoverflo.site", "https://stackoverflowclone.site", "https://won-stackoverflow.site", "https://port-0-build-test-nx562olfqifnzt.sel3.cloudtype.app"));
