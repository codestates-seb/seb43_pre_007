...
public class QuestionControllerTest {
    ...
    public void postQuestionTest() throws Exception {
        ...
        //response
        QuestionUserResponseDto user = new QuestionUserResponseDto(userId, "홍길동");
        QuestionDto.Response question = new QuestionDto.Response(1L, "질문제목", body, false, false,
                0, 0, LocalDateTime.now(),LocalDateTime.now(),tags );
    ...
    public void getQuestionTest() throws Exception {
        ...
        //response
        QuestionUserResponseDto user = new QuestionUserResponseDto(1, "홍길동");
        ...
        QuestionDto.Response question = new QuestionDto.Response(1L, "질문제목", questionBody, true, false,
                1, 2, LocalDateTime.now(),LocalDateTime.now(),tags);

        String answerBody = "답변 글의 본문은 최소 30자 이상이어야 합니다. 그렇지 않으면 답변을 등록 할 수 없습니다.";
        QuestionUserResponseDto user2 = new QuestionUserResponseDto(2, "답변작성자1");
        QuestionUserResponseDto user3 = new QuestionUserResponseDto(3, "답변작성자2");
        List<QuestionAnswerResponseDto> answers = List.of(new QuestionAnswerResponseDto(user2,1, answerBody,false, LocalDateTime.now(),LocalDateTime.now()),
                                                        new QuestionAnswerResponseDto(user3,2, answerBody,false, LocalDateTime.now(),LocalDateTime.now()));
    ...
    public void getQuestionsTest() throws Exception {
        ...
        QuestionUserResponseDto user1 = new QuestionUserResponseDto(1, "홍길동1");
        QuestionUserResponseDto user2 = new QuestionUserResponseDto(2, "홍길동2");
