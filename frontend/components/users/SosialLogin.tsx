...
const Socialbutton = styled.button<SocialProps>`
  width: 100%;
  height: 2.3rem;
  margin: 4px 0px;
  text-align: center;
  ...
  &:hover {
    background: ${(props) => props.hoverbg || 'orange'};
  }
  &:active {
    background: ${(props) => props.hoverbg || 'purple'};
    box-shadow: 0px 0px 0px 4px ${(props) => props.activebs || 'green'};
  }
`;
